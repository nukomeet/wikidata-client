...
describe Wikidata::Property::Time do
  ...
  it 'should return a range of DateTime' do
    range_of_year.tap do |date|
      ...
      date.range.max.should eq DateTime.new(1505, 12, 31, 0o0, 0o0, 0o0)
    end
  end

  it 'should handle BC dates' do
    bc_date.date.should eq DateTime.new(-2_500_000, 1, 1, 0, 0, 0)
    bc_date.range.min.should eq DateTime.new(-2_500_000, 1, 1, 0, 0, 0)
    bc_date.range.max.should eq DateTime.new(-2_500_000, 1, 1, 0, 0, 0)
  end
